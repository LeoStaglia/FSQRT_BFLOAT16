...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPISetCallerName(0, "C:/Users/liuna/FSQRT_BFLOAT16/bfloat_sqrt_0.1/bfloat_sqrt_0.1.srcs/sim_1/new/tb_sqrt.sv") ;
		DPISetCallerLine(0, 133) ;
		DPISetCallerOffset(0, 2544) ;
		DPIAllocateDPIScopes(1) ;
		DPISetDPIScopeFunctionName(0, "DPI_fsqrt") ;
		DPISetDPIScopeHierarchy(0, "tb_sqrt") ;
		DPIRelocateDPIScopeIP(0, (char*)(0x4c50)) ;
	}
...
extern "C" {
	...
	extern unsigned int DPI_fsqrt(unsigned int arg0) ;
}
