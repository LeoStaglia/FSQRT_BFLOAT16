...
module tb_lampFPU;
	...
	import "DPI-C" function int unsigned DPI_fsqrt( input int unsigned op1, input int isOpInv);
...
//		end
	...
	task TASK_doSqrt_op (input opcodeFPU_t opcode, input logic [LAMP_FLOAT_DW-1:0] op, input logic isOpInv);
	   logic [31:0] tb_res;
	   
	   tb_res = DPI_fsqrt(op << (LAMP_INTEGER_DW - LAMP_FLOAT_DW), isOpInv);
